...
const lazyExecutors: Record<string, () => Promise<BaseExecutor>> = {
  ...
  "zai-web": () =>
    process.env.OMNIROUTE_EXECUTOR_V2 === "on"
      ? import("./zai-web-v2.ts").then((m) => new m.ZaiWebExecutorV2())
      : import("./zai-web.ts").then((m) => new m.ZaiWebExecutor()),
  zw: () =>
    process.env.OMNIROUTE_EXECUTOR_V2 === "on"
      ? import("./zai-web-v2.ts").then((m) => new m.ZaiWebExecutorV2())
      : import("./zai-web.ts").then((m) => new m.ZaiWebExecutor()), // Alias
